...
{
    public partial class Igra3x4 : Form
    {
        ...
        public Igra3x4(List<Kartica>memory,int RedniBroj)
        {
            InitializeComponent();
            BrojPoteza = 0;
            MeduPotez = 0;
            ...
            //promijesaj
            ListaKartica.PromijesajKartice(memory);
            int i = 0;
            foreach (Label lbl in lstLabel)
            {
                lbl.BackColor = Color.Transparent;
                lbl.Text = memory[i].tekst;
                i++;
            }
        }

        //Ako su dvije odabrane karte par
        ...
        //Ako dvije odabrane karte nisu par
